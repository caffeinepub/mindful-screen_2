...
export class Backend implements backendInterface {
    ...
    async getAllNotesSortedByTimestamp(): Promise<Array<Note>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllNotesSortedByTimestamp();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllSessionRecords(): Promise<Array<[bigint, bigint]>> {
        if (this.processError) {
            try {
    ...
    async getDailyTimeLimit(): Promise<bigint | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getDailyTimeLimit();
    ...
    async getNoteById(arg0: bigint): Promise<Note | null> {
        if (this.processError) {
            try {
    ...
    async getTodaysSessionRecords(arg0: bigint): Promise<Array<[bigint, bigint]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTodaysSessionRecords(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveSessionRecord(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveSessionRecord(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setDailyTimeLimit(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setDailyTimeLimit(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Note]): Note | null {
    return value.length === 0 ? null : value[0];
}
